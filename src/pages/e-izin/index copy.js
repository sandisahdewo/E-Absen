...
export default class Index extends Component {
  ...
  storeIzin = () => {
    const formData = { 
      ...
      image_swafoto_base64: this.state.image_lampiran_base64,
      image_lampiran_base64: this.state.image_lampiran_base64,
      jenis_izin_id: this.state.jenis_izin.id,
      tanggal_awal_izin: this.state.tanggal_awal_izin,
      tanggal_akhir_izin: this.state.tanggal_akhir_izin
    }
